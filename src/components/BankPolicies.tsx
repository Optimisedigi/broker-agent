...
function BankPolicies() {
  ...
  const getPoliciesForBank = (bankName: string) =>
    policies.filter((p) => p.bank_name === bankName)
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <button
            onClick={() => { setSelectedBank(null); setShowForm(false) }}
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={() => {
              ...
              setNewPolicy({ bank_name: selectedBank, policy_name: '', requirements: '', notes: '' })
            }}
              ...
              <div key={policy.id} className="card">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-3">
                  {policy.min_income != null && (
                    <div>
                      <span className="text-gray-400">Min Income:</span> ${policy.min_income.toLocaleString()}
                    </div>
                  )}
                  {policy.max_ltv != null && (
                    <div>
