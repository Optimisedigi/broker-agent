...
function Clients() {
            ...
            {!hasData ? (
              <div className="text-center text-gray-500">
                ...
                <p className="text-sm mt-1">
                  This document was imported before preview support was added.
                </p>
              </div>
            ) : ext === "pdf" ? (
              <embed src={previewDoc.fileData} type="application/pdf" className="w-full h-[70vh]" />
  ...
  if (selectedClient) {
    ...
    const hasMissingFields =
      ...
      !selectedClient.available_deposit ||
      !selectedClient.liabilities ||
    ...
    return (
      <div ref={clientDetailRef} className="space-y-6">
            ...
            <div className="flex items-center gap-3">
                ...
                {editingProfile ? (
                  <span className="flex gap-2">
                    <input
                      ...
                      className="input text-xl font-semibold w-40"
                    />
                    <input
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    await invoke("update_client_status", {
                      clientId: selectedClient.id,
                      status: newStatus,
                    });
        ...
        {showDeleteConfirm && (
          <div className="card bg-red-50 border-red-200">
            ...
            <p className="text-sm text-red-700 mb-3">
              ...
              and all associated data (deals, documents, meetings). Type <strong>DELETE</strong> to
              confirm.
            </p>
            <div className="flex items-center gap-3">
              <input
        ...
        {(() => {
          const stages =
            selectedClient.client_status === "existing"
              ? PIPELINE_STAGES_EXISTING
              : PIPELINE_STAGES_NEW;
          const currentStage =
            selectedClient.pipeline_stage ||
            (selectedClient.client_status === "existing" ? "review" : "lead_received");
        ...
        <div className="card">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              {editingProfile ? (
                <div className="space-y-2">
                  ...
                  />
                  <select
                    value={editForm.home_ownership || "owned"}
                    onChange={(e) => setEditForm({ ...editForm, home_ownership: e.target.value })}
                    className="input text-sm"
                  >
                  ...
                  {selectedClient.home_address && (
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium flex-shrink-0 ${
                        selectedClient.home_ownership === "renting"
                          ? "bg-orange-100 text-orange-800"
                          : selectedClient.home_ownership === "joint"
            ...
            <div>
              ...
              {editingProfile ? (
                <textarea
                  value={editForm.investment_addresses || ""}
                  onChange={(e) =>
                    setEditForm({ ...editForm, investment_addresses: e.target.value })
                  }
                  className="input text-sm"
                  rows={3}
                  placeholder="Address | Value (one per line)"
                />
              ...
              {editingProfile ? (
                <textarea
                  value={editForm.properties_viewing || ""}
                  onChange={(e) => setEditForm({ ...editForm, properties_viewing: e.target.value })}
                  className="input text-sm"
                  rows={2}
              ...
              {editingProfile ? (
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      payg: e.target.value ? Number(e.target.value) : undefined,
                    })
                  }
                  className="input mt-1"
                />
              ...
              {editingProfile ? (
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      assets: e.target.value ? Number(e.target.value) : undefined,
                    })
                  }
                  className="input mt-1"
                />
          ...
          <div className="grid grid-cols-3 gap-4">
              ...
              {editingProfile ? (
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      liabilities: e.target.value ? Number(e.target.value) : undefined,
                    })
                  }
                  className="input mt-1"
                />
            ...
            <div>
              ...
              {editingProfile ? (
                <input
                  type="number"
                  value={editForm.available_deposit ?? ""}
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      available_deposit: e.target.value ? Number(e.target.value) : undefined,
                    })
                  }
                  className="input mt-1"
                />
              ...
              {editingProfile ? (
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                      monthly_expenses: e.target.value ? Number(e.target.value) : undefined,
                    })
                  }
                  className="input mt-1"
                />
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                ...
                {clientDeals.length > 0 && (
                  <span className="ml-2">
                    ($
                    {clientDeals.reduce((sum, d) => sum + (d.loan_amount || 0), 0).toLocaleString()}{" "}
                    total brokered)
                  </span>
                )}
              </p>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewDeal({
                        ...newDeal,
                        loan_amount: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input text-sm"
                    placeholder="$"
                  ...
                  <div key={deal.id} className="bg-gray-50 rounded-lg overflow-hidden">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full font-medium capitalize ${statusColor}`}
                          >
                            {deal.status}
                          </span>
                    ...
                    {isExpanded && (
                      <div className="px-3 pb-3 ml-6 space-y-3">
                        <div className="grid grid-cols-4 gap-3">
                          ...
                          <div className="bg-white rounded-lg p-2 text-center border">
                            ...
                            <p className="text-sm font-medium">
                              {deal.interest_rate ? `${deal.interest_rate.toFixed(2)}%` : "-"}
                            </p>
                          </div>
                          <div className="bg-white rounded-lg p-2 text-center border">
                        ...
                        {deal.notes && <p className="text-sm text-gray-600 italic">{deal.notes}</p>}
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <button
                              onClick={() =>
                                setShowAddEvent(showAddEvent === deal.id ? null : (deal.id ?? null))
                              }
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setNewEvent({ ...newEvent, old_value: e.target.value })
                                    }
                                    className="input text-sm"
                                    placeholder="e.g., 5.99%"
                                  />
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setNewEvent({ ...newEvent, new_value: e.target.value })
                                    }
                                    className="input text-sm"
                          ...
                          {events.length === 0 ? (
                            ...
                            <div className="relative ml-2">
                              ...
                              <div className="space-y-3">
                                {events.map((ev) => {
                                  const typeColor =
                                    ev.event_type === "purchase" || ev.event_type === "settlement"
                                      ? "bg-green-500"
                                      : ev.event_type === "refinance"
                                        ? "bg-purple-500"
                                        : ev.event_type === "rate_change" ||
                                            ev.event_type === "repayment_change"
                                          ? "bg-blue-500"
                                          : ev.event_type === "discharge"
                                            ? "bg-red-500"
                                            : "bg-gray-400";
                                  return (
                                    <div key={ev.id} className="relative pl-5">
                                      <div
                                        className={`absolute left-0 top-1.5 w-3 h-3 rounded-full ${typeColor} border-2 border-white`}
                                      />
                                      <div>
                                        <div className="flex items-center gap-2">
              ...
              <div className="grid grid-cols-4 gap-3 mb-4">
                <div className="bg-gray-50 rounded-lg p-2 text-center">
                  ...
                  <p className="font-semibold text-sm">
                    ${(selectedClient.income || 0).toLocaleString()}
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-2 text-center">
                  <p className="text-xs text-gray-500">Deposit</p>
                  <p className="font-semibold text-sm">
                    ${(selectedClient.available_deposit || 0).toLocaleString()}
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-2 text-center">
                  <p className="text-xs text-gray-500">Liabilities</p>
                  <p className="font-semibold text-sm">
                    ${(selectedClient.liabilities || 0).toLocaleString()}
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-2 text-center">
                  <p className="text-xs text-gray-500">Expenses/mo</p>
                  <p className="font-semibold text-sm">
                    ${(selectedClient.monthly_expenses || 0).toLocaleString()}
                  </p>
                </div>
              </div>
                    ...
                    return (
                      <div key={match.policy.id} className={`border rounded-lg p-3 ${borderColor}`}>
                        ...
                        <p
                          ...
                          title={match.policy.policy_name}
                        >
                          {match.policy.policy_name}
                        </p>
                        <div className="flex items-center justify-between text-xs text-gray-600 mb-2">
                          <span className="font-semibold text-blue-700">
                            {match.policy.interest_rate?.toFixed(2)}%
                          </span>
                        ...
                        <div className="space-y-0.5">
                          <div className="flex items-center gap-1 text-xs">
                            ...
                            <span className="text-gray-500 truncate">
                              Income min ${((match.policy.min_income || 0) / 1000).toFixed(0)}K
                            </span>
                          </div>
                          <div className="flex items-center gap-1 text-xs">
                            {match.lvrPass ? (
                            ...
                            <button
                              onClick={(e) => {
                                ...
                                setTranscriptExpanded(
                                  isTranscriptOpen ? null : (meeting.id ?? null),
                                );
                              }}
                            ...
                            onSubmit={async (e) => {
                              ...
                              try {
                                ...
                                if (selectedClient?.id) {
                                  const docs = await invoke<any[]>("get_client_documents", {
                                    clientId: selectedClient.id,
                                  });
                                  setClientDocuments(docs);
                                }
        ...
        <div className="flex gap-2">
          {showForm && (
            <button
              type="button"
              onClick={() =>
                (document.getElementById("new-client-form") as HTMLFormElement)?.requestSubmit()
              }
          ...
          <button
            ...
            className={
              showForm
                ? "px-4 py-2 rounded text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200"
                : "btn-primary"
            }
          >
          ...
          <form id="new-client-form" onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewClient({ ...newClient, investment_addresses: e.target.value })
                    }
                    className="input"
                    rows={3}
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    One property per line: Address | Estimated Value
                  </p>
                </div>
              </div>
              <div className="mt-2">
                <label className="block text-sm font-medium mb-1">
                  Properties Currently Being Viewed
                </label>
                <textarea
                  value={newClient.properties_viewing || ""}
                  onChange={(e) =>
                    setNewClient({ ...newClient, properties_viewing: e.target.value })
                  }
                  className="input"
                  rows={2}
                  placeholder="One address per line"
            ...
            <div className="border-t pt-4 mt-4">
              ...
              <p className="text-xs text-gray-500 mb-3">
                Auto-populated from meeting transcriptions and email imports. You can also enter or
                edit these manually.
              </p>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({
                        ...newClient,
                        payg: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input"
                    placeholder="$"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({
                        ...newClient,
                        assets: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input"
                    placeholder="$"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({
                        ...newClient,
                        liabilities: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input"
                    placeholder="$"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({
                        ...newClient,
                        available_deposit: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input"
                    placeholder="$"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewClient({
                        ...newClient,
                        monthly_expenses: e.target.value ? parseFloat(e.target.value) : undefined,
                      })
                    }
                    className="input"
                    placeholder="$"
