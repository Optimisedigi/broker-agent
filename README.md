...
|----------|-----------|-------|
| macOS (Apple Silicon) | [Brokeragent.dmg](https://github.com/Optimisedigi/broker-agent/releases/latest) | macOS 12+ |
| Windows | [Brokeragent_Setup.exe](https://github.com/Optimisedigi/broker-agent/releases/latest) | Windows 10+ |

Download the latest release from the [Releases page](https://github.com/Optimisedigi/broker-agent/releases).
